...
if (!function_exists('ostende_customizer_get_css')) {

	function ostende_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = ostende_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('ostende_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(ostende_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = ostende_get_scheme_colors($scheme);
...
.scheme_self.sc_layouts_row_type_normal .search_wrap .search_submit:before {
	color: {$colors['text_link']};
}
...
.ostende_tabs .ostende_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.ostende_tabs .ostende_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sheme_self.sidebar .ostende_tabs .ostende_tabs_titles li.ui-state-active a {
...
.post_item .post_title a:hover strong,
...
.post_item_single .post_featured .post_categories a:hover,
...
.post_item_single .post_meta_item:focus,
.post_item_single .post_header .post_meta .vc_inline-link:focus,
.post_item_single .post_meta_item > a:focus,
.post_item_single .post_meta_item .socials_caption:focus,
.post_item_single .post_edit a:focus {
	color: {$colors['text_hover']};
}
...
.related_wrap .related_item.related_item_style_1 {
	background-color: {$colors['inverse_dark']};
}
.related_wrap .related_item_style_1 .post_title a,
.related_wrap .related_item_style_1 .post_title a em,
.related_wrap .related_item_style_1 .post_title a b{
	color: {$colors['inverse_link']};
}
.related_wrap .related_item_style_1 .post_title a:hover,
.related_wrap .related_item_style_1 .post_title a:hover em,
.related_wrap .related_item_style_1 .post_title a:hover b,
.related_wrap .related_item_style_1 .post_title a:focus,
.related_wrap .related_item_style_1 .post_title a:focus em,
.related_wrap .related_item_style_1 .post_title a:focus b{
	color: {$colors['extra_link']};
}
...
.related_wrap .related_item_style_1 .post_categories a:focus {
...
.comments_list_wrap .comment_text table > tbody th {
	background-color: {$colors['extra_bg_color']};
}
...
.scheme_self.sidebar .widget .widget_title a,
.scheme_self.sidebar .widget .widgettitle a {
	color: {$colors['bg_color']};
}
.sidebar .widget .widget_title a:hover,
.sidebar .widget .widgettitle a:hover,
.scheme_self.sidebar .widget .widget_title a:hover,
.scheme_self.sidebar .widget .widgettitle a:hover {
	color: {$colors['text_link']};
}

.sidebar .widget .widget_title,
.sidebar .widget .widgettitle,
.scheme_self.sidebar .widget .widget_title,
.scheme_self.sidebar .widget .widgettitle {
	background-color: {$colors['text_dark']};
	color: {$colors['bg_color']};
}
.widget ul > li:before {
...
.post_featured.hover_zoom .post_info a {
	color: {$colors['inverse_link']};
}
.post_featured.hover_zoom .post_info a:hover {
	color: {$colors['extra_link']};
}
...
footer .elementor-section .sc_layouts_iconed_text .sc_layouts_item_icon {
	color: {$colors['text_link']};
}
...
.elementor-widget-wp-widget-mc4wp_form_widget.extra .mc4wp-form .mc4wp-form-fields input[type="submit"]:hover {
	background-color: {$colors['inverse_dark']};
	color: {$colors['inverse_link']};
}
...
.wpcf7-form div .select_container:focus:before,
.wpcf7-form div .select_container:hover:before,
...
.ui-datepicker th,
div.ui-datepicker table a:hover {
	color: {$colors['extra_link']} !important;
}
.ui-datepicker .ui-datepicker-title,
...
CSS;
					...
					$rez = apply_filters('ostende_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'ostende_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>